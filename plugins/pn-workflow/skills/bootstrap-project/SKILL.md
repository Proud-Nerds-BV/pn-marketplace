...
If all of the above hold, the project is bootstrapped. If not, consumer skills abort with: "Project not fully bootstrapped; run `/pn-workflow:bootstrap-project`."
